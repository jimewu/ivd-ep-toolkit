...
DIR <- "ivd-ep-toolkit/09-Method-Comparison"
TIME <- format(Sys.time(), "%Y-%m%d-%H%M%S")
RPRT.DIR <- paste("Report_for_Method_Comparison", TIME, sep = "_")
setwd("~")
WD <- getwd()
WD <- paste(WD, DIR, sep = "/")
setwd(WD)
...
err.rto <- SET$EP9.Error_Ratio # Ratio of repeatability of 2 methods
